      ...
      <main>
        <div class="container-fluid px-4">
          ...
          <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item active">Berikut merupakan Daftar Klien yang tersedia!</li>
          </ol>
          ...
          <div class="container">
            <div class="card mb-4">
              ...
              <div class="card-body">
                <form id="form-multidelete" action="Klien.php" method="post">
                  <button type="button" class="btn btn-primary mb-2" data-bs-toggle="modal" data-bs-target="#createKlienModal">Tambah Klien Baru</button>
                  ...
                  <table id="datatablesSimple">
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          <td><input type="checkbox" name="id_klien[]" value="<?= $id_klien ?>" class="checkItem"></td>
                          <td><?= $id_klien ?></td>
                          <td><?= $namaklien ?></td>
                          <td>
                            <button type="button" class="btn btn-primary editKlienBtn" data-id="<?= $id_klien ?>" data-nama="<?= $namaklien ?>">Edit</button>
                          </td>
                        </tr>
                      <?php } ?>
                    </tbody>
          ...
          <!-- Create -->
          <div class="modal fade" id="createKlienModal" tabindex="-1" aria-labelledby="createKlienModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="createKlienModalLabel">Tambah Klien Baru</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  <form id="form-create-task" action="createKlien.php" method="post">
          ...
          <div class="modal fade" id="editKlienModal" tabindex="-1" aria-labelledby="editKlienModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="editKlienModalLabel">Edit Proyek</h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                  <form id="form-edit-Task" action="editKlien.php" method="post">
                    <input type="hidden" id="edit_id_klien" name="id_klien">
                    <div class="form-group">
                      <label for="edit_nama_klien">Nama Klien:</label>
                      <input type="text" id="edit_nama_klien" name="nama_klien" class="form-control" required>
                    </div>
                    <br>
          ...
          <script>
            document.addEventListener('DOMContentLoaded', function() {
              ...
              document.querySelector('tbody').addEventListener('click', function(e) {
                if (e.target.classList.contains('editKlienBtn')) {
                  ...
                  new bootstrap.Modal(document.getElementById('editKlienModal')).show();
                }
              });
