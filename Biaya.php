                ...
                <table id="datatablesSimple">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= $jmlBiaya ?></td>
                            <td>
                                <button type="button" class="btn btn-primary editBiayaBtn" data-id="<?= $id_biaya ?>" data-jml="<?= $jmlBiaya ?>">Edit</button>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form id="form-create-Price" action="createBiaya.php" method="post">
...
<div class="modal fade" id="editBiayaModal" tabindex="-1" aria-labelledby="editBiayaModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editBiayaModalLabel">Edit Proyek</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="form-edit-Price" action="editBiaya.php" method="post">
          <input type="hidden" id="edit_id_biaya" name="id_biaya">
          <div class="form-group">
            <label for="edit_jml_biaya">Jumlah Biaya:</label>
            <input type="text" id="edit_jml_biaya" name="jml_biaya" class="form-control" required>
          </div>
          <br>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector('tbody').addEventListener('click', function (e) {
        if (e.target.classList.contains('editBiayaBtn')) {
            ...
            const jml = e.target.dataset.jml;
