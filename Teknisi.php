                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <button type="button" class="btn btn-primary editTeknisiBtn" data-id="<?= $id_teknisi ?>" data-nama="<?= $namateknisi ?>" data-idkontraktor="<?= $idKontraktor ?>" data-namakontraktor="<?= $namaKontraktor ?>">Edit</button>
                          </td>
                        </tr>
                      <?php } ?>
                    </tbody>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="form-create-Teknisi" action="createTeknisi.php" method="post" enctype="multipart/form-data">
          ...
          <div class="modal fade" id="editTeknisiModal" tabindex="-1" aria-labelledby="editTeknisiModalLabel" aria-hidden="true">
            <div class="modal-dialog">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <form id="form-edit-Teknisi" action="editTeknisi.php" method="post" enctype="multipart/form-data">
                    <input type="hidden" id="edit_id_teknisi" name="id_teknisi">
                    <div class="form-group">
                      <label for="edit_nama_teknisi">Nama Teknisi:</label>
                      <input type="text" id="edit_nama_teknisi" name="nama_teknisi" class="form-control">
                    </div>
                    <div class="form-group">
            ...
            document.addEventListener('DOMContentLoaded', function() {
              ...
              document.querySelector('tbody').addEventListener('click', function(e) {
                if (e.target.classList.contains('editTeknisiBtn')) {
                  ...
                  const idkontraktor = e.target.idkontraktor;
                  const namakontraktor = e.target.namakontraktor;
