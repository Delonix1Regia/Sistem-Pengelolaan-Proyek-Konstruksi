                ...
                <table id="datatablesSimple">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" class="btn btn-primary editTaskBtn" data-id="<?= $id_tugas ?>" data-nama="<?= $namaTugas ?>" data-material="<?= $data['id_material'] ?>" data-proyek="<?= $data['id_proyek'] ?>" data-progress="<?= $data['id_progress'] ?>">Edit</button>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
...
<div class="modal fade" id="editTaskModal" tabindex="-1" aria-labelledby="editTaskModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="editTaskModalLabel">Edit Proyek</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      <div class="modal-body">
        <form id="form-edit-Task" action="editTugas.php" method="post">
          ...
          <div class="form-group">
            <label for="edit_id_material">Material:</label>
            <select id="edit_id_material" name="id_material" class="form-control" required>
              <?php
              $query = "SELECT * FROM material";
              $result = mysqli_query($koneksi, $query);
              while ($row = mysqli_fetch_array($result)) {
          ...
          <div class="form-group">
            <label for="edit_id_proyek">Proyek:</label>
            <select id="edit_id_proyek" name="id_proyek" class="form-control" required>
              <?php
              $query = "SELECT * FROM proyek";
              $result = mysqli_query($koneksi, $query);
              while ($row = mysqli_fetch_array($result)) {
          ...
          <div class="form-group">
            <label for="edit_id_progress">Progress:</label>
            <select id="edit_id_progress" name="id_progress" class="form-control" required>
              <?php
              $query = "SELECT * FROM progress";
              $result = mysqli_query($koneksi, $query);
              while ($row = mysqli_fetch_array($result)) {
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    document.querySelector('tbody').addEventListener('click', function (e) {
        if (e.target.classList.contains('editTaskBtn')) {
            ...
            document.getElementById('edit_id_material').value = material;
            document.getElementById('edit_id_proyek').value = proyek;
            document.getElementById('edit_id_progress').value = progress;
